...
Для выполнения запросов требуется особым образом подписать их. Правила подписи находятся [тут](https://github.com/deviint/onlyfans-dynamic-rules).


Прочий код, используемый в качестве референса:

- https://github.com/taux1c/onlyfans-scraper
...
- https://github.com/jordon31/OnlySnap
- https://github.com/Hashirama/OFDL
- https://github.com/UltimaHoarder/UltimaScraper
- https://www.npmjs.com/package/ui-logger-dom?activeTab=readme


## Разработка

В коде много мусора. Не удаляю, потому что не знаю, что из этого мусора может пригодиться. 

Релизить стоит через `npm run build`. Браузер натравливаем на папку `build`.


=====================================

This content from original repo.
